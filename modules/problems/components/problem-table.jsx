...
const ProblemsTable = ({ problems, user }) => {
  ...
  const allTags = useMemo(() => {
    ...
    const tagsSet = new Set();              // Set duplicate values store nahi karta.
  ...
  // useMemo: Iska use isliye kiya hai taaki jab tak problems change na ho, tab tak yeh calculation baar-baar na chale (Performance optimization).
